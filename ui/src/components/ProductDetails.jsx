  ...
  return (
    <div className='ProductDetails'>
      <div className='leftSideDetails'>
        <h2>{product.name}</h2>
        <div>
          <span className='detail'>Brand: </span> {product.brand}
        </div>
        <div>
          <span className='detail'>Type: </span> {product.type}
        </div>
        <div>
          <span className='detail'>Price: </span> {product.price}€
        </div>
        <div>
          <span className='detail'>Disponibitily: </span>
          <span style={{ color: product.stockQuantity > 0 ? 'green' : 'red' }}>inStock</span>
